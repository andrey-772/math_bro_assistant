...
class SolveBySimpleIterationMethod():
    def get_dataset(self, table_index: str, blank: bool=False, for_method: bool=False, is_1=False) -> dict:
        dataset_keys_list = []
    ...
    def get_the_form(self, table_index: str):
        if table_index == "21":
    ...
    def collect_data_from_matrix_tables(self, tables_data: dict) -> list:
        """
    ...
    def calculate_iteration(self, matrix_A: dict, matrix_B: dict, k_index: int=0) -> dict:
         """
