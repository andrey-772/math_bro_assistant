...
def task2_1():
    ...
    print(f"2 крок. Значення граничних відносних похибок змінних: {second_step_res[0], second_step_res[1], second_step_res[2]}")
    print(f"3 крок. Значення f приблизне {first_step_res}, f граничне відносна похибка {third_step_res[0]},  f гранична абсолютна похибка {third_step_res[1]}")
...
def task2_2():
    ...
    print(f"2 крок. Значення граничних відносних похибок змінних: {second_step_res[0], second_step_res[1], second_step_res[2]}")
    print(f"3 крок. Значення Q приблизне {first_step_res}, Q граничне відносна похибка {third_step_res[0]},  Q гранична абсолютна похибка {third_step_res[1]}")
